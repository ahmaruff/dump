import { v as useHead, n as useNuxtApp, l as useRuntimeConfig } from '../server.mjs';
import { defineComponent, ref, computed, h } from 'vue';
import { G as encodeParam, q as hasProtocol, H as withLeadingSlash, j as joinURL, r as parseURL, p as defu, I as encodePath } from '../../nitro/node-server.mjs';
...
const ipxRuntime$dvawORxY9R = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$dvawORxY9R, defaults: void 0 }
};
const useImage = () => {
