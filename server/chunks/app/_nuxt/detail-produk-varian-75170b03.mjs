...
import { _ as _sfc_main$3 } from './AddonApexcharts-47238aef.mjs';
import { defineComponent, reactive, ref, withCtx, createVNode, unref, mergeProps, useSSRContext } from 'vue';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/produk/detail-produk-varian.vue");
