...
const index = defineEventHandler(async (event) => {
  ...
  return {
    ...
    project: slug ? data.find((item) => item.slug === slug) : void 0
  };
});
function filterDemoData(data, filter, page, perPage) {
  ...
  return data.filter((item) => {
    return [item.name, item.owner.name, item.category].some(
  ...
  return Promise.resolve([
    {
      ...
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quid iudicant sensus? Primum quid tu dicis breve? Etiam beatissimum? Ne discipulum abducam, times.",
      meta: {
        sprintPerWeek: 2,
        monthDuration: 3,
        budgetType: "Fixed"
      ...
      tasks: [
        ...
        },
        {
          ...
          description: "The website should provide a customizable landing page template that can be used to support marketing campaigns. It should also be easily customizable by the marketing team.",
          completion: 58,
          status: 1,
          assignee: {
            id: 12,
        ...
        },
        {
          ...
          description: "Since we couldn't find an out of the box solution, we are forced to build a custom player that we can reuse in othe projects.",
          completion: 45,
          status: 1,
          created: "18 days ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The customer wants to have a set of illustrations that can be used on the website and the app. They should be custom branded and fit the overall design.",
          completion: 100,
          status: 5,
          created: "2 weeks ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The API endpoint should return a JSON list of jobs. The endpoint should be able to filter the results by keyword, location, type and category.",
          completion: 65,
          status: 1,
          created: "2 weeks ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The API endpoint should return a JSON list of users. The endpoint should be able to filter the results by keyword, location, type and category.",
          completion: 100,
          status: 0,
          created: "2 days ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The authentication system should be able to handle user registration, login, logout, password reset and email verification. The API endpoint should return a Bearer token.",
          completion: 100,
          status: 0,
          created: "2 days ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The components should be able to handle different pricing plans and should be able to display the most popular plan. Also, the components should be able to display a button to purchase the plan.",
          completion: 100,
          status: 5,
          created: "2 weeks ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The user profile page should display the user avatar, name, email, bio, location, social links and a list of the user projects.",
          completion: 100,
          status: 5,
          created: "3 weeks ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The contact list page should display a list of contacts with their name, email, phone number and avatar.",
          completion: 75,
          status: 3,
          created: "2 weeks ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The contact list API endpoint should return a list of contacts with their name, email, phone number and avatar.",
          completion: 50,
          status: 1,
          created: "6 days ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The messaging frontend should allow users to send messages to each other. The messages should be stored in a database. The frontend should be implemented in React.",
          completion: 100,
          status: 5,
          created: "2 weeks ago",
          assignee: {
        ...
        },
        {
          ...
          description: "The messaging API endpoint should allow users to send messages to each other. The messages should be stored in a database. The API endpoint should be implemented in Node.js.",
          completion: 65,
          status: 1,
          created: "3 weeks ago",
          assignee: {
